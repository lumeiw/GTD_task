...
abstract interface class ITaskEntity {
  ...
  DateTime? get date; // Дата, связанная с задачей (например, дедлайн или запланированная дата)
  String get formattedDate;
  List<TaskFlag> get flags; // Список флагов, описывающих статус или особенности задачи
  ...
  String? get projectId; // ID проекта, к которому относится задача (null, если не относится к проекту)
}
